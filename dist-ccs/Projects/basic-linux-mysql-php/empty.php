...
class clsempty { //empty class @1-7B5B7FB3
...
//Class_Initialize Event @1-95803AF0
    function clsempty($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "empty.php";
        $this->Redirect = "";
        $this->TemplateFileName = "empty.html";
