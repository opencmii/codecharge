...
class clsmenu_site { //menu_site class @1-A3F115D6
...
//Class_Initialize Event @1-507C633E
    function clsmenu_site($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "menu_site.php";
        $this->Redirect = "";
        $this->TemplateFileName = "menu_site.html";
...
} //End menu_site Class @1-FCB6E20C
