<Page id="1" templateExtension="html" relativePath=".." fullRelativePath=".\inc" secured="False" urlType="Relative" isIncluded="True" SSLAccess="False" isService="False" cachingEnabled="False" cachingDuration="1 minutes" wizardTheme="None" wizardThemeVersion="3.0" useDesign="False" needGeneration="0">
	<Components>
		<Directory id="2" secured="False" sourceType="Table" name="menu" connection="basic_mysql_php" originalDataSource="menu" dataSource="menu cat, menu sub" categoryID="cat_menu_id" subcategoryID="sub_menu_id" wizardCaption="menu" wizardCreatePath="False" wizardNoCategories="{res:CCS_NoCategories}" wizardCaptionPath="{res:menu_DirectoryForm}" wizardUseInterVariables="True" changedCaptionDirectory="False" wizardThemeApplyTo="Page" directoryAddTemplatePanel="False">
			<Components>
				<Link id="11" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="CategoryLink" fieldSource="cat_menu_name" hrefSource="siteMenu.ccp" PathID="siteMenumenuCategoryLink">
					<Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="13" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="SubcategoryLink" fieldSource="sub_menu_name" hrefSource="../cont.ccp" PathID="siteMenumenuSubcategoryLink" wizardUseTemplateBlock="False" linkProperties="{'textSource':'','textSourceDB':'sub_menu_name','hrefSource':'../cont.ccp','hrefSourceDB':'','title':'','target':'','name':'','linkParameters':{'0':{'sourceType':'DataField','parameterSource':'sub_menu_id','parameterName':'menu_id'},'length':1,'objectType':'linkParameters'}}"><Components/>
					<Events/>
					<LinkParameters>
				...
				<Link id="15" visible="Yes" fieldSourceType="DBColumn" dataType="Text" html="False" hrefType="Page" urlType="Relative" preserveParameters="GET" name="SubcategoriesTailLink" fieldSource="cat_menu_name" hrefSource="siteMenu.ccp" wizardDefaultValue="{res:CCS_More}" PathID="siteMenumenuSubcategoriesTailLink">
					<Components/>
					<Events/>
					<LinkParameters>
