...
class clslight_menu { //light_menu class @1-D84E905C
...
//Class_Initialize Event @1-83B907C1
    function clslight_menu($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "light_menu.php";
        $this->Redirect = "";
        $this->TemplateFileName = "light_menu.html";
...
} //End light_menu Class @1-FCB6E20C
