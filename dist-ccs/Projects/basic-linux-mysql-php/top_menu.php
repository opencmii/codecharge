...
//Class_Initialize Event @1-815A5687
    function clstop_menu($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "top_menu.php";
        $this->Redirect = "";
        $this->TemplateFileName = "top_menu.html";
