...
class clsnav_menu { //nav_menu class @1-4576EDFB
...
//Class_Initialize Event @1-F1E22230
    function clsnav_menu($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "nav_menu.php";
        $this->Redirect = "";
        $this->TemplateFileName = "nav_menu.html";
