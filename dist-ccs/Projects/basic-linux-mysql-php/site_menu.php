...
class clssite_menu { //site_menu class @1-38724418
...
//Class_Initialize Event @1-38AF1707
    function clssite_menu($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "site_menu.php";
        $this->Redirect = "";
        $this->TemplateFileName = "site_menu.html";
...
} //End site_menu Class @1-FCB6E20C
