...
class clscontent_main { //content_main class @1-37E1BF07
...
//Class_Initialize Event @1-57C01294
    function clscontent_main($RelativePath, $ComponentName, & $Parent)
    {
        global $CCSLocales;
        ...
        $this->Visible = true;
        $this->Parent = & $Parent;
        $this->FileName = "content_main.php";
        $this->Redirect = "";
        $this->TemplateFileName = "content_main.html";
...
} //End content_main Class @1-FCB6E20C
